          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1">
                ...
                <span>+231-777-842609</span>
              </div>
              <div className="flex items-center space-x-1">
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+231-880-557574</span>
              </div>
              <div className="flex items-center space-x-1">
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@dksliberia.org" className="hover:text-white">
                  info@dksliberia.org
                </a>
              </div>
            </div>
      ...
      >
        <div className="container-custom">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Mobile Menu Button */}
            <button
              className="md:hidden p-2 rounded-lg text-text hover:bg-gray-100"
                ...
                <div className="py-3 space-y-3">
                  {navLinks.map((link) => (
                    <Link
                      ...
                      className={`block px-3 py-2 rounded-lg font-medium transition-colors text-sm ${
                        router.pathname === link.href
